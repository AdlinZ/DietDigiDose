...
export type PreferenceOutcome = { id: string; recipeId: number | null; title: string; kind: "production" | "eat" | "discard" | "inventory" | "plan_change"; at: string; servings?: number; quantity?: number; unit?: string; valid: boolean; explanation: string; correctionId?: string; correctedAt?: string };
