...
function repository(overrides: Partial<HouseholdsRepository> = {}): HouseholdsRepository {
  return {
    reserveMeal: async () => ({}),meals: async () => [],eatMeal: async () => ({}),produceMeal: async () => ({}), diningRecipe: async () => null, diningMembers: async () => [], diningPreferences: async () => null,saveDiningPreferences: async () => false,
