...
const draftTemplate: Manifest = {
  voiceId: 'voice-cn', name: '中文合成音色', version: '1.0.0', language: 'zh-CN', gender: 'unspecified',
  ...
  model: { path: 'model.onnx', vocabularyPath: 'vocab.json', inputNames: { tokens: 'input', lengths: 'input_lengths' }, outputName: 'output' },
};
