...
export default function VoicePacks() {
  ...
  const [status, setStatus] = useQueryState<VoicePackStatus | 'all'>('status', 'all', ["all", "draft", "published", "disabled", "revoked"]);
