...
function repository(overrides: Partial<HouseholdsRepository> = {}): HouseholdsRepository {
  return {
    meals: async () => [],eatMeal: async () => ({}),produceMeal: async () => ({}), diningRecipe: async () => null, diningMembers: async () => [], diningPreferences: async () => null,saveDiningPreferences: async () => false,
