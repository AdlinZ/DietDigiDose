...
export const aiApi = {
  ...
  homeRecommendations: <T>(apiFetch: ApiFetch, period: string) => requestJson<T>(apiFetch, "/api/v1/ai/home-recommendations", { method: "POST", body: JSON.stringify({ period }), timeoutMs: 60_000 }),
